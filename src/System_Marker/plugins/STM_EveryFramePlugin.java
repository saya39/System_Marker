...
public class STM_EveryFramePlugin extends BaseEveryFrameCombatPlugin {
    ...
    protected static boolean enableDistanceMarker = false;
    ...
    public void init(CombatEngineAPI engine) {
        ...
        try {
            ...
            enableDistanceMarker = getBoolean(cfg, "enableDistanceMarker", enableDistanceMarker);
        ...
        if (enableDistanceMarker) {
            engine.addPlugin(new STM_DistanceMarkerPlugin());
        }
    }
    ...
    protected static float getValueFromLevel(float level, float start, float end){
    ...
    protected static int clamp(int min, int num, int max) {
        return Math.max(min, Math.min(num, max));
    }
