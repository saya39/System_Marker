...
public class STM_TorpedoMarkerPlugin extends STM_EveryFramePlugin {
    ...
    private String alarmSE = "STM_alarm";
    ...
    public void init(CombatEngineAPI engine) {
        ...
        try {
            ...
            alarmSE = getString(cfg, "alarmSE", alarmSE);
...
//    }
    ...
    private void playAlarm(float dangerClass, ShipAPI ship) {
        ...
        if (dangerClass >= alarmDamageLv1 && dangerClass <= alarmDamageLv2) {
            Global.getSoundPlayer().playLoop(alarmSE + "_lv1", ship, 1f, alarmVolumeMult, ship.getLocation(), ship.getVelocity(), 0f, 0.5f);
        } else if (dangerClass > alarmDamageLv2 && dangerClass <= alarmDamageLv3) {
            Global.getSoundPlayer().playLoop(alarmSE + "_lv2", ship, 1f, alarmVolumeMult, ship.getLocation(), ship.getVelocity(), 0f, 0.5f);
